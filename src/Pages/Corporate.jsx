...
const Corporate = () => {
  return (
    <>
        ...
        <h1 className="text-4xl font-roboto capitalize text-black font-light">Corporate Concepts</h1>
        </div>
        </section>
        ...
        <section className="w-full my-24">
            <div className="w-full px-6 lg:px-14 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="img w-full h-[500px]">
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img w-full h-[500px]">
                    <img src="https://images.unsplash.com/photo-1462826303086-329426d1aef5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1yZWxhdGVkfDV8fHxlbnwwfHx8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img relative w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/290275/pexels-photo-290275.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="house-image" className='w-full object-cover h-full' />
