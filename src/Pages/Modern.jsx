...
const Modern = () => {
  return (
    <>
        ...
        <h1 className="text-4xl font-roboto capitalize text-black font-light">Modern Building</h1>
        </div>
        </section>
        ...
        <section className="w-full my-24">
            <div className="w-full px-6 lg:px-14 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="img w-full h-[500px]">
                    <img src="https://images.unsplash.com/photo-1515263487990-61b07816b324?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/2659515/pexels-photo-2659515.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/1719477/pexels-photo-1719477.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="house-image" className='w-full h-full' />
                </div>
