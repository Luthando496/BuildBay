...
const Interior = () => {
  return (
    <>
        ...
        <h1 className="text-4xl font-castoro capitalize text-black font-light">Corporate Tower</h1>
        </div>
        </section>
        ...
        <section className="w-full my-24">
            <div className="w-full px-6 lg:px-14 grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="img w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/5847398/pexels-photo-5847398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/5886283/pexels-photo-5886283.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="house-image" className='w-full h-full' />
                </div>
                <div className="img w-full h-[500px]">
                    <img src="https://images.pexels.com/photos/6123601/pexels-photo-6123601.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="house-image" className='w-full h-full' />
                </div>
